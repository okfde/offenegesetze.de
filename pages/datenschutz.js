  ...
  <BaseContent>
    ...
    <div class="lurking-header">
      ...
      <p>
        ...
        „wir“ bezeichnet) betreibt die im Internet unter https://okfn.de/ und
        den jeweils dazu gehörenden Unterverzeichnissen abrufbare Internetseite
        (nachfolgend „okfn.de“ oder die „Website“).
      </p>
      <p>
      ...
      <h3>
        II. Personenbezogene Daten, Zwecke und Rechtsgrundlage der
        Datenverarbeitung
      </h3>
      ...
      <ul>
        <li>
          ...
          Sie betreffende personenbezogene Daten verarbeitet werden und wenn ja,
          welche dies sind sowie die näheren Umstände der Datenverarbeitung.
        </li>
        <li>
          <strong>Art. 16 DS-GVO – Recht auf Berichtigung:</strong> Sie haben
          das Recht, von uns unverzüglich die Berichtigung Sie betreffender
          unrichtiger personenbezogener Daten zu verlangen. Dabei haben Sie
          unter Berücksichtigung der Zwecke der Verarbeitung auch das Recht, die
          Vervollständigung unvollständiger personenbezogener Daten – auch
          mittels einer ergänzenden Erklärung – zu verlangen.
        </li>
        <li>
          <strong>Art. 17 DS-GVO – Recht auf Löschung:</strong> Sie haben das
          Recht, von uns zu verlangen, dass Sie betreffende personenbezogene
          Daten unverzüglich gelöscht werden. Beachten Sie hier bitte die unter
        ...
        <li>
          <strong>Art. 20 DS-GVO – Recht auf Datenübertragbarkeit:</strong> Sie
          haben das Recht, im Falle der Verarbeitung aufgrund einer Einwilligung
          oder zur Erfüllung eines Vertrags, die Sie betreffenden
          ...
          zu übermitteln oder die Daten direkt an den anderen Verantwortlichen
          übermitteln zu lassen, soweit dies technisch machbar ist.
        </li>
        <li>
          <p>
            <strong>Art. 21 DS-GVO – Widerspruchsrecht:</strong> Sie haben das
            ...
            Daten, die aufgrund eines berechtigten Interesses unsererseits oder
            zur Wahrung einer Aufgabe im öffentlichen Interesse erforderlich
            ist, oder die in Ausübung öffentlicher Gewalt erfolgt, Widerspruch
            einzulegen.
          </p>
          <p>
        ...
        <li>
          ...
          Arbeitsplatzes oder des Orts des mutmaßlichen Verstoßes, einzulegen,
      ...
      <ul>
        ...
        <li>
          Informationen über den verwendeten Internet-Browser und das verwendete
          Betriebssystem,
        </li>
        <li>
